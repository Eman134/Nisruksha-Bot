...
API.getProgress = function(maxticks, tickchar, seekpos, atual, max, percento) {
    ...
    const bar = '[' + progressText + emptyProgressText + "] "+ (percento ? atual + "%" : "(" + atual + "/" + max +")") ;
    return bar;
}
