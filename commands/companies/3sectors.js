module.exports = {
	...
	async execute(API, msg) {
        ...
        .addField('**<:icon6:778594558745378846> Pescaria**', `Nesse setor você compra iscas, melhore a sua vara de pesca e fique rico vendendo peixes, que vença o melhor pescador!`)
